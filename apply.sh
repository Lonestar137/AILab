...
original_author="Lonestar137"
original_name="ailab"
original_urlname="AILab"
original_description="Awesome ailab created by Lonestar137" 
...
then
    ...
    echo "then run 'ailab' or 'python -m ailab'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'ailab' or 'python -m ailab' or 'poetry run ailab'"
fi
