...
- 🎯 Entry points to execute your program using `python -m <ailab>` or `$ ailab` with basic CLI argument parsing.
...
---
# ailab Flask Application

Awesome ailab created by Lonestar137
...
```bash
ailab create-db   # run once
ailab populate-db  # run once (optional)
ailab add-user -u admin -p 1234  # ads a user
ailab run
```
