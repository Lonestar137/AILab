...
release:          ## Create a new tag for release.
	...
	@git tag $${TAG}
	@echo "$${TAG}" > ailab/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add ailab/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "ailab = 'ailab.__main__:main'" >> pyproject.toml 
	...
	@echo "Please run 'poetry shell' or 'poetry run ailab'"
